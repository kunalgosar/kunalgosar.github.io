...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if insect.name == "Queen" and insect.imposter == False:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        for place in range(self.min_range):
            current_place = current_place.entrance
        i = 0
        while current_place is not hive and i<=self.max_range:
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        self.doubled_ants=[]
        if QueenAnt.is_placed:
            self.imposter=True
        else:
            QueenAnt.is_placed=True
            self.imposter=False
        # END Problem 9
    ...
    def action(self, colony):
        ...
        def double_damage(ant):
            if ant and ant not in self.doubled_ants and ant.name != "Queen":
                ant.damage *= 2
